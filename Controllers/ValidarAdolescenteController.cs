...
{
    public class ValidarAdolescenteController : Controller
    {
        // GET: ValidarAdolescente
        ...
        [HttpPost]
        public ActionResult Index(FormularioAdolescentes vf)
        {
            ...
            using (sqlconn)
            {
                ...
                try
                {
                    ...
                    sqlcomm.Parameters.AddWithValue("@id_campa", 1);
        ...
        public void To_pdf(FormularioAdolescentes vf)
        {
        ...
        public void enviodecorreo(MemoryStream memorystr, FormularioAdolescentes vf)
        {
            try
            {
