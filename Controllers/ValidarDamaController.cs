...
{
    public class ValidarDamaController : Controller
    {
        // GET: ValidarDama
        ...
        [HttpPost]
        public ActionResult Index(FormularioDamas vf)
        {
            ...
            using (sqlconn)
            {
                try
                {
                    ...
                    sqlcomm.Parameters.AddWithValue("@Genero", "M");
                    ...
                    sqlcomm.Parameters.AddWithValue("@id_campa", 3);
         ...
         public void To_pdf(FormularioDamas vf)
        {
            string camisa = "", talla = "";
            ...
            doc.Add(new Paragraph("                       " + "Genero: Mujer"));
        ...
        public void enviodecorreo(MemoryStream memorystr, FormularioDamas vf)
        {
            try
            {
