...
{
    public class ValidarSenorController : Controller
    {
        // GET: ValidarSenor
        ...
        [HttpPost]
        public ActionResult Index(FormularioSenores vf)
        {
            ...
            using (sqlconn)
            {
                try
                {
                    ...
                    sqlcomm.Parameters.AddWithValue("@Genero", "H");
                    sqlcomm.Parameters.AddWithValue("@EstadoCivil", "Casado");
                    ...
                    sqlcomm.Parameters.AddWithValue("@id_campa", 4);
                    sqlcomm.ExecuteNonQuery();
                    ViewData["Message"] = "Inserción correcta";
                    sqlconn.Close();
                    To_pdf(vf);
                    ModelState.Clear();
                }
                ...
                {
                    ModelState.AddModelError("", "Insercion incorrecta");
          ...
          public void To_pdf(FormularioSenores vf)
        {
            string camisa = "", talla = "";
            ...
            doc.Add(new Paragraph("                       " + "Genero: Hombre"));
        ...
        public void enviodecorreo(MemoryStream memorystr, FormularioSenores vf)
        {
            try
            {
